...
from Lib.schedule.getter import (
    get_num_of_lesson,
    get_type_of_week,
    get_type_of_lesson,
    get_name_of_lesson,
                    ...
                    if "." in cell.value and "," in cell.value:
                        ...
                        if "." in dates.value:
                            ...
                            data = {
                                ...
                                "all_subgroups": find_max_sheet(book=book_data)
                                - 2,
                            ...
                            print(
                                f'В ячейче с датами нет "." - {dates.value} '
