...
def schedule_str(data: dict, subgroup: str, date: str) -> str:
    ...
    times_of_lesson = ['8:30 - 10:00', '10:10 - 11:40', '12:40 - 14:10', 
        '14:20 - 15:50', '16:00 - 17:30', '18:00 - 19:30', '19:40 - 21:10']
...
def passwords_info_str() -> str:
    ...
    text = '🔵Для добавления пароля, находясь в данной вкладке '\
        ...
        'такой же пароль, перейдите на страницу '\
        '"Другое" -> "Сообщения"'\
        'и введите <пароль> <сообщение>.\n' \
...
def messages_str() -> str:
    """ Выводит str рассылки сообщений по паролю """
    text = f'Формат сообщения: <пароль> <сообщение>'\
        f'\nПример: 123 Всем привет!' \
        f'\n(всем пользователям с введенным кодовым словом '\
        f'"123" отправится сообщение "Всем привет!" )'
    return text
...
def short_description() -> str:
    ...
    text = f'1) Расписание групп.'\
        ...
        f'важную информацию, есть функция '\
        f'"Сообщения" во вкладке "Другое".'\
        ...
        f'во вкладку "Другое" -> "Сообщения" -> "Пароли"'\
