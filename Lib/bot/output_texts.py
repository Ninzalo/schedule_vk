...
def short_description() -> str:
    text = f'1) Расписание групп.\n'\
            f'🔵 Для того чтобы посмотреть расписание своей группы в первый '\
            ...
            f'выбранной группы"\n'\
            f'ℹ️ В боте есть Возможность сохранить 4 группы, чтобы вы '\
            ...
            f'   *При условии, что сохранённых групп больше 1\n'\
            f'При необходимости можно удалить группу, нажав на '\
            f'соответствующую кнопку, и сохранить новую.\n\n'\
            f'2) Рассылка расписания.\n'\
            f' 🔵Для того чтобы получать рассылку расписания '\
            f'( и никогда не забывать какие завтра пары ) нужно зайти '\
            f'во вкладку "Другое" на начальной странице. Нажав кнопку '\
            f'"Рассылка расписания", выбрать удобную для Вас:\n'\
            f' - Ежедневная Рассылка (в 20.00 каждый день)\n'\
            f' - Еженедельная Рассылка( в субботу  в 20.00 каждую неделю)\n'\
            f' ℹ️ Рассылка производится для ВЫБРАННОЙ ГРУППЫ. Вы '\
            f'можете получать рассылку для всех нужных Вам групп, '\
            f'если повторите эти действия,  выбирая каждый раз '\
            f'другую группу.\n\n'\
            f'3) Рассылка мемов группе в данном боте так же возможна! '\
            f'А если серьезно:\n'\
            f'🔵 Для того чтобы рассылать (в помощь старостам) '\
            f'важную информацию есть функция "Пароли" во вкладке "Другое".\n'\
            f' ℹ️ Вы придумываете пароль, другие его вводят, и '\
