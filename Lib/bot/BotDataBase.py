...
class BotDB:
    ...
    def get_form(self, user_id: int) -> str:
        ...
        result = self.cursor.execute(
            sql, (user_id, self.get_preset(user_id=user_id))
        )
    ...
    def change_form(self, user_id: int, form: str) -> None:
        ...
        WHERE user_id = ? AND preset_num = ?"""
        self.cursor.execute(
            sql, (form, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
    ...
    def change_fac(self, user_id: int, fac: str) -> None:
        ...
        WHERE user_id = ? AND preset_num = ?"""
        self.cursor.execute(
            sql, (fac, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
    ...
    def change_group_page(self, user_id: int, group_page: int) -> None:
        ...
        WHERE user_id = ? AND preset_num = ?"""
        self.cursor.execute(
            sql, (group_page, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
    ...
    def change_session_group_page(
        self, user_id: int, session_group_page: int
    ) -> None:
        ...
        self.cursor.execute(
            sql,
            (session_group_page, user_id, self.get_preset(user_id=user_id)),
        )
        return self.conn.commit()
    ...
    def change_group(self, user_id: int, group: str) -> None:
        ...
        WHERE user_id=? AND preset_num = ? """
        self.cursor.execute(
            sql, (group, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
    ...
    def change_subgroup(self, user_id: int, subgroup: str) -> None:
        ...
        WHERE user_id=? AND preset_num = ? """
        self.cursor.execute(
            sql, (subgroup, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
    ...
    def change_week_page(self, user_id: int, week_page: int) -> None:
        ...
        WHERE user_id=? AND preset_num = ? """
        self.cursor.execute(
            sql, (week_page, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
    ...
    def change_date_page(self, user_id: int, date_page: int) -> None:
        ...
        WHERE user_id=? AND preset_num = ? """
        self.cursor.execute(
            sql, (date_page, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
    ...
    def change_daily_mail(self, user_id: int, daily_mail: int) -> None:
        ...
        WHERE user_id=? AND preset_num = ? """
        self.cursor.execute(
            sql, (daily_mail, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
    ...
    def change_weekly_mail(self, user_id: int, weekly_mail: int) -> None:
        ...
        WHERE user_id=? AND preset_num = ? """
        self.cursor.execute(
            sql, (weekly_mail, user_id, self.get_preset(user_id=user_id))
        )
        return self.conn.commit()
        ...
        if success:
            ...
            if creator == None:
                ...
                if not str(privacy) == "None":
                    ...
                    self.cursor.execute(
                        sql, (user_id, password, creator, privacy)
                    )
                else:
                    success = 101
            self.conn.commit()
